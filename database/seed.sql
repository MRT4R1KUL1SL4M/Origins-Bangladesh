...
-- Optional cleanup for reruns against an already-seeded fresh schema
DELETE FROM buyer_vault_tag;
DELETE FROM admin_permission;
DELETE FROM notification;
DELETE FROM security_event;
DELETE FROM action_approval;
DELETE FROM email_template;
DELETE FROM report_export;
...
DELETE FROM seller_support_message;
DELETE FROM seller_gi_application;
DELETE FROM seller_transaction;
DELETE FROM seller_payout_method;
DELETE FROM seller_wallet;
DELETE FROM seller_verification_doc;
...
DELETE FROM gi_tag_verification_log;
DELETE FROM buyer_profile;
DELETE FROM buyer_vault_tag;
DELETE FROM gi_tag;
DELETE FROM soundscape_track;
DELETE FROM gi_journal_article;
DELETE FROM artisan_product;
DELETE FROM artisan_story;
DELETE FROM product;
DELETE FROM artisan;
DELETE FROM district_atlas;
...
DELETE FROM ob_id_sequence;
DELETE FROM email_template;
DELETE FROM system_setting WHERE setting_key IN (
  'site_name','site_tagline','default_currency','platform_fee_percent','support_email','support_phone',
  'admin_notice','featured_artisan_id','featured_story_id','hero_journal_slug'
);
...
(2, 'admin', 'Operations Admin', 'mrtarikulislamtarek69@gmail.com', '8801700000002', 'pbkdf2:sha256:600000$VZFLVGeP$19a1c6d59ac7599b17ccfb6f5726d6204d0fdabc56fab6b6395649da1521da97', 'pbkdf2:sha256:600000$VZFLVGeP$19a1c6d59ac7599b17ccfb6f5726d6204d0fdabc56fab6b6395649da1521da97', 1, 1),
(3, 'buyer', 'Buyer Tarek', 'titarek1122@gmail.com', '8801700000003', 'pbkdf2:sha256:600000$VZFLVGeP$19a1c6d59ac7599b17ccfb6f5726d6204d0fdabc56fab6b6395649da1521da97', 'pbkdf2:sha256:600000$VZFLVGeP$19a1c6d59ac7599b17ccfb6f5726d6204d0fdabc56fab6b6395649da1521da97', 1, 1),
(4, 'seller', 'Seller Tarek', 'titarek2211@gmail.com', '8801700000004', 'pbkdf2:sha256:600000$VZFLVGeP$19a1c6d59ac7599b17ccfb6f5726d6204d0fdabc56fab6b6395649da1521da97', 'pbkdf2:sha256:600000$VZFLVGeP$19a1c6d59ac7599b17ccfb6f5726d6204d0fdabc56fab6b6395649da1521da97', 1, 1),
(5, 'seller', 'Heritage Seller', 'seller2@origins.local', '8801700000005', 'pbkdf2:sha256:600000$VZFLVGeP$19a1c6d59ac7599b17ccfb6f5726d6204d0fdabc56fab6b6395649da1521da97', 'pbkdf2:sha256:600000$VZFLVGeP$19a1c6d59ac7599b17ccfb6f5726d6204d0fdabc56fab6b6395649da1521da97', 1, 1),
(6, 'buyer', 'Collector Buyer', 'buyer2@origins.local', '8801700000006', 'pbkdf2:sha256:600000$VZFLVGeP$19a1c6d59ac7599b17ccfb6f5726d6204d0fdabc56fab6b6395649da1521da97', 'pbkdf2:sha256:600000$VZFLVGeP$19a1c6d59ac7599b17ccfb6f5726d6204d0fdabc56fab6b6395649da1521da97', 1, 1);
...
VALUES
(3, 'Kaliganj, Gazipur, Bangladesh', 'Loves handmade heritage products and verified crafts.', '/static/assets/img/placeholder.jpg', 120, 'OB-0003'),
(6, 'Dhanmondi, Dhaka, Bangladesh', 'Collector of rare handcrafted and GI-inspired items.', '/static/assets/img/placeholder.jpg', 80, 'OB-0006');
...
VALUES
(4, 'Tarik Artisan Shop', 'Tarik', 'Kaliganj, Gazipur', 'Textiles', 'A growing seller profile used for login, verification and dashboard testing.', '/static/assets/img/placeholder.jpg', 0, 'under_review', 2, NOW(), NULL),
(5, 'Sonar Bangla Crafts', 'Rahim Uddin', 'Narayanganj', 'Jamdani & Heritage Crafts', 'A verified shop selling GI-inspired heritage products and featured artisan collections.', '/static/assets/img/placeholder.jpg', 1, 'approved', 2, NOW(), NULL);
...
VALUES
(1, 'Amena Khatun', 'Jamdani Weaver', 'Narayanganj, Bangladesh', 'Master Weaver', '/static/assets/img/placeholder.jpg', 'Jamdani', 'Every thread carries memory.', 2003, 22, 860, 1, 1),
(2, 'Harun Mia', 'Pottery Artist', 'Rajshahi, Bangladesh', 'Clay Heritage', '/static/assets/img/placeholder.jpg', 'Pottery', 'Clay remembers the hand that shaped it.', 2008, 17, 430, 0, 1);
...
VALUES
(1, 'Loom Rhythm', 'Ambient sounds from a weaving studio', 182, 'https://example.com/audio/loom-rhythm.mp3', '/static/assets/img/placeholder.jpg', 'Jamdani', 1, 1, 1, 1),
(2, 'Clay Workshop', 'Wheel, water and kiln ambience', 205, 'https://example.com/audio/clay-workshop.mp3', '/static/assets/img/placeholder.jpg', 'Pottery', 3, 0, 2, 1);
...
VALUES
(1, 'jamdani-river-heritage', 'Jamdani by the River', 'Why place matters in woven identity', 'Heritage Journal', 6, '/static/assets/img/placeholder.jpg', '/static/assets/img/placeholder.jpg', 'Exploring how riverine trade and artisan memory shaped Jamdani.', '<p>Jamdani remains one of the most recognizable craft traditions linked to Bengal heritage.</p>', 1, 'Craft is geography made visible.', 'Editorial Desk', NOW()),
(2, 'craft-economy-new-sellers', 'How new sellers earn trust', 'Verification, consistency and storytelling', 'Marketplace', 4, '/static/assets/img/placeholder.jpg', '/static/assets/img/placeholder.jpg', 'A guide to production-grade marketplace trust signals.', '<p>Seller verification, accurate product listings and responsive support improve buyer confidence.</p>', 0, NULL, NULL, NOW());
...
VALUES
(1, 5, 'Handwoven Jamdani Saree', 'Verified heritage-inspired saree with premium handwoven motifs.', 8500.00, 12, 1, 1, 1, 'GI-JAM-0001', '/static/assets/img/placeholder.jpg', 1, 10, 92.4500, 1),
(2, 5, 'Nakshi Kantha Throw', 'Decorative embroidered throw inspired by folk storytelling patterns.', 4200.00, 8, 1, 2, 3, 'GI-NK-0002', '/static/assets/img/placeholder.jpg', 0, NULL, 87.2300, 1),
(3, 4, 'Khadi Panjabi', 'Seller verification test product for locked seller flows.', 2500.00, 5, 1, 1, 2, NULL, '/static/assets/img/placeholder.jpg', 0, NULL, 71.0000, 1),
(4, 5, 'Terracotta Vase', 'Decorative handcrafted clay vase suitable for modern interiors.', 1800.00, 15, 2, 3, 3, NULL, '/static/assets/img/placeholder.jpg', 0, NULL, 66.5000, 1),
(5, 5, 'Jute Storage Basket', 'Natural fiber storage basket with heritage-inspired weaving.', 1200.00, 20, 4, 5, 4, NULL, '/static/assets/img/placeholder.jpg', 1, 15, 61.4000, 1);
